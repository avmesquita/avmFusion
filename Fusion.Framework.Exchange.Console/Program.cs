...
namespace Fusion.Framework.Exchange
{
    /// <summary>
    ...
    public class Program
    {
                ...
                foreach (var item in disponibilidade)
                {
                    ...
                    if (item.Status.StatusDisponibilidade == Models.StatusDisponibilidade.EmReuniao)
                    {
                        ...
                        else
                        {
                            ...
                            //new SendMailBS().Sendmail("andre.mesquita@Fusion.com.br", situacao);
                        }
                    }
        ...
        {
            string path = string.Format("http://Fusionexchangearduino.azurewebsites.net/Fusion.Exchange.Arduino/api/LogEvento/GetAmostragemDispositivoAtivo?smtp={0}",smtp);
        ...
        private static void GetDispositivosPareados()
        {
            ...
            string path = "http://Fusionexchangearduino.azurewebsites.net/api/Device/GetDispositivosPareados";
            ...
            var listaDispositivo = y.Content.ReadAsAsync<ICollection<Fusion.Framework.Exchange.Entity.Dispositivo>>(formatters);
