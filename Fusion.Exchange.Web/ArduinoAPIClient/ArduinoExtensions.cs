...
namespace Fusion.Exchange.Web.ArduinoAPI
{
    public static partial class ArduinoExtensions
    {
        ...
        /// Reference to the Fusion.Exchange.Web.ArduinoAPI.IArduino.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Fusion.Exchange.Web.ArduinoAPI.Models.SalaDeReuniao>> result = await operations.GetWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Fusion.Exchange.Web.ArduinoAPI.Models.SalaDeReuniao>> result = await operations.GetClienteByIdclienteWithOperationResponseAsync(idCliente, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
