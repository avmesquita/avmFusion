using Impeto.Exchange.Configuration.Helpers;
...
namespace Impeto.Exchange.Configuration.Controllers
{
    public class QRCodeController : Controller
    {
        ...
        {            
            string htmlimagem = "<img src = 'http://impetoexchangeconfiguration.azurewebsites.net/QRCode/Generate?texto='"+ "http://impetoexchangeconfiguration.azurewebsites.net/" + "' alt='Ímpeto Sala de Reunião' style='' />";
        ...
        public ActionResult Generate(string texto)
        {
            ...
            {
                texto = "http://impetoexchangeconfiguration.azurewebsites.net/Account/Register/?FirstDevice=" + texto;
            }
            ...
            Response.AddHeader("Content-Disposition", "inline; filename=ImpetoDeviceQRCode.gif");
