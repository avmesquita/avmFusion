...
namespace Impeto.Exchange.Configuration.Controllers
{
    public class DispositivoController : Controller
    {
        ...
        */
        ...
        {
            const string devPath = "http://localhost/Impeto.Exchange.Arduino/Impeto.Exchange.Arduino/api/Arduino";
            const string prodPath = "http://impetoexchangearduino.azurewebsites.net/Impeto.Exchange.Arduino/api/Arduino";
