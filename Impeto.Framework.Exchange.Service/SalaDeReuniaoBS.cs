...
using Impeto.Framework.Exchange.Authentication;
...
namespace Impeto.Framework.Exchange.Service
{
    public class SalaDeReuniaoBS
    {
        ...
        private ExchangeService service
        {
            get
            {
                return Impeto.Framework.Exchange.Authentication.Service.ConnectToService(UserDataFromConsole.GetUserData(
                                                                                                               this.email,
                                                                                                               this.senha,
