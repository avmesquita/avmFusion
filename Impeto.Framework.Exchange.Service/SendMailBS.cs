...
namespace Impeto.Framework.Exchange.Service
{
    public class SendMailBS
    {
        public void Sendmail(string to, string traceContent)
        {
            ...
            postman.Credentials = new System.Net.NetworkCredential("andre.mesquita.impeto@gmail.com", "impeto.mesquita.andre");
            postman.Port = 465;
