...
namespace Impeto.Exchange.Arduino.Controllers
{
    public class ArduinoController : ApiController
    {
        ...
        [HttpPost]
        //[Route("Impeto.Exchange.Arduino/api/Arduino/Post")]
        [Route("Impeto.Exchange.Arduino/api/Arduino/Post/{smtp}/{haspeople}")]
        ...
        [HttpPost]
        [Route("Impeto.Exchange.Arduino/api/Arduino/Limpar/{token}")]
        ...
        /*
        [HttpPost]
        [Route("Impeto.Exchange.Arduino/api/Arduino/LimparHistorico/{token}")]
        ...
        {
            string path = string.Format("http://impetoexchangeconfiguration.azurewebsites.net/api/Dispositivo/GetDevice/{0}",serial);
