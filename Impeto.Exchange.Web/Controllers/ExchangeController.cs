...
namespace Impeto.Exchange.Web.Controllers
{
    public class ExchangeController : ApiController
    {
        ...
        {
            var retorno = new Impeto.Framework.Exchange.Service.SalaDeReuniaoBS().obterDisponibilidadeSalaReuniao(zoneId);
            return retorno;
        }
        ...
        public Status obterDisponibilidadeExchange(string smtp)
        {
            ...
            var retorno = new Impeto.Framework.Exchange.Service.SalaDeReuniaoBS().obterDisponibilidadeExchange(smtp);
            return retorno;
        }
        ...
        {
            var rooms = new Impeto.Framework.Exchange.Service.SalaDeReuniaoBS().getRoomLists();
            return rooms;
        }
        ...
        {
            var rooms = new Impeto.Framework.Exchange.Service.SalaDeReuniaoBS().getRooms(smtpBuildingRoom);
            return rooms;
        }
    }
}
