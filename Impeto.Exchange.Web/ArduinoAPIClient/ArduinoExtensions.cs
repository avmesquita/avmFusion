...
namespace Impeto.Exchange.Web.ArduinoAPI
{
    public static partial class ArduinoExtensions
    {
        ...
        /// Reference to the Impeto.Exchange.Web.ArduinoAPI.IArduino.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Impeto.Exchange.Web.ArduinoAPI.Models.SalaDeReuniao>> result = await operations.GetWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Impeto.Exchange.Web.ArduinoAPI.Models.SalaDeReuniao>> result = await operations.GetClienteByIdclienteWithOperationResponseAsync(idCliente, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        /// Optional.
        /// </param>
        public static string PostBySmtpAndHaspeopleAndIdcliente(this IArduino operations, string smtp, string haspeople, int? idCliente = null)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IArduino)s).PostBySmtpAndHaspeopleAndIdclienteAsync(smtp, haspeople, idCliente);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// Cancellation token.
        /// </param>
        public static async Task<string> PostBySmtpAndHaspeopleAndIdclienteAsync(this IArduino operations, string smtp, string haspeople, int? idCliente = null, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Microsoft.Rest.HttpOperationResponse<string> result = await operations.PostBySmtpAndHaspeopleAndIdclienteWithOperationResponseAsync(smtp, haspeople, idCliente, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
    }
}
